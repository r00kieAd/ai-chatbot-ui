...
This is a simple and causally built chatbot interface built with React, TypeScript, and Vite. This application provides a sleek user experience for interacting with multiple AI language models with support for file uploads, markdown rendering, and advanced animations. It is connected with llm-rotuer service for communication with LLMs.
